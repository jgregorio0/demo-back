...
import dev.jgregorio.demo.back.infrastructure.persistence.location.LocationEntity;
...
@Getter
@Setter
public class CenterEntity extends AuditorEntity {

  @EmbeddedId private CenterEntityId id;
