package dev.jgregorio.demo.back.infrastructure.persistence.user.search;

import dev.jgregorio.demo.back.domain.user.UserSearch;
import dev.jgregorio.demo.back.infrastructure.persistence.user.UserEntity;
import dev.jgregorio.demo.back.infrastructure.persistence.user.UserEntity_;
