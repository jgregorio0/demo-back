package dev.jgregorio.demo.back.application.user;
...
class UserServiceTest {
  ...
  void search_shouldReturnListOfUsers_whenUsersMatchCriteria() {
    ...
    List<User> expectedUsers =
        List.of(User.builder().username("user1").build(), User.builder().username("user2").build());
    ...
    verify(userPersistence).search(criteria, sort);
  }
