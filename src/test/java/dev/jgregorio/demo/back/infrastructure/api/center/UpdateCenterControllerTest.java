...
class UpdateCenterControllerTest extends ApiPresentationTestHelper {
  ...
  void update_shouldUpdateCenter_whenRequestIsValid() throws Exception {
    ...
    verify(updateMapper).fromRequest(any(CenterUpdateRequest.class));
    verify(centerService).update(centerUpdate);
  ...
  void update_shouldReturnBadRequest_whenIdIsNull() throws Exception {
    ...
    verify(centerService, never()).update(any(CenterUpdate.class));
  }
