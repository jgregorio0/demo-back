...
class ReadCenterControllerTest extends ApiPresentationTestHelper {
  ...
  void get_shouldFindCenter_whenRequestIsValid() throws Exception {
    ...
    verify(readMapper).fromRequest(any(CenterReadRequest.class));
  ...
  void get_shouldReturnBadRequest_whenIdIsNull() throws Exception {
    ...
    verify(centerService, never()).read(any(CenterRead.class));
  }
